        ...
        "./node_modules/@storybook/components/dist/esm/controls/Color.js": (
            ...
            var s = function (e, r, t) {
                ...
                d = function (e, r, t) {
                    ...
                    return {
                        left: s(
                            (o.pageX - (n.left + v(e).pageXOffset)) / n.width
                        ),
                        top: s(
                            (o.pageY - (n.top + v(e).pageYOffset)) / n.height
                        ),
                    };
                },
                h = function (e) {
            ...
            var F,
                ...
                G = {
                    ...
                    equal: function (e, r) {
                        return (
                            e.toLowerCase() === r.toLowerCase() || A(x(e), x(r))
                        );
                    },
                },
                Q = function (r) {
            ...
            var Wrapper = esm.zo.div({ position: "relative", maxWidth: 250 }),
                PickerTooltip = (0, esm.zo)(lazy_WithTooltip.R)({
                    position: "absolute",
                    zIndex: 1,
                    top: 4,
                    left: 4,
            ...
            var COLOR_SPACES = Object.values(ColorSpace),
                            ...
                            return (
                                _defineProperty(
                                    (_ref8 = {
                                        ...
                                        value,
                                        keyword:
                                            color_convert_default().rgb.keyword(
                                                [r, g, b]
                                            ),
                            ...
                            return (
                                _defineProperty(
                                    (_ref11 = {
                                        ...
                                        value,
                                        keyword:
                                            color_convert_default().hsl.keyword(
                                                [_h, _s2, _l]
                                            ),
                            ...
                            function () {
                                return (function getRealValue(
                                    ...
                                    if (!color.hex.startsWith("#"))
                                        try {
                                            return "#".concat(
                                                color_convert_default().keyword.hex(
                                                    color.hex
                                                )
                                            );
                                        } catch (e) {
                ...
                ColorControl = function ColorControl(_ref13) {
            ...
            Object.keys(conversions).forEach(function (fromModel) {
                ...
                Object.keys(routes).forEach(function (toModel) {
                    ...
                    (convert[fromModel][toModel] = (function wrapRounded(fn) {
                        ...
                        (convert[fromModel][toModel].raw = (function wrapRaw(
                            fn
                        ) {
                            var wrappedFn = function wrappedFn() {
                                for (
