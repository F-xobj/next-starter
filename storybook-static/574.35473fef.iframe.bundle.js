        ...
        "./node_modules/@storybook/components/dist/esm/tooltip/WithTooltip.js":
            (
                ...
                function Manager(_ref) {
                    ...
                    var handleSetReferenceNode = react.useCallback(function (
                        node
                    ) {
                ...
                function getBoundingClientRect(element, includeScale) {
                    ...
                    if (isHTMLElement(element) && includeScale) {
                        ...
                        offsetWidth > 0 &&
                            ...
                            offsetHeight > 0 &&
                                (scaleY =
                                    round(rect.height) / offsetHeight || 1);
                    }
                    return {
                ...
                function getWindowScrollBarX(element) {
                    return (
                        getBoundingClientRect(getDocumentElement(element))
                            .left + getWindowScroll(element).scrollLeft
                    );
                }
                ...
                function listScrollParents(element, list) {
                    ...
                    var scrollParent = getScrollParent(element),
                        isBody =
                            scrollParent ===
                            (null ==
                            (_element$ownerDocumen = element.ownerDocument)
                                ? void 0
                ...
                function isTableElement(element) {
                    return (
                        ["table", "td", "th"].indexOf(getNodeName(element)) >= 0
                    );
                }
                                      ...
                                      if (
                                          ...
                                          -1 !==
                                              [
                                                  "transform",
                                                  "perspective",
                                              ].indexOf(css.willChange) ||
                                          (isFirefox &&
                                              "filter" === css.willChange) ||
                                          (isFirefox &&
                                              css.filter &&
                                              "none" !== css.filter)
                                      )
                                ...
                                setOptions: function setOptions(
                                    ...
                                    var orderedModifiers =
                                        (function orderModifiers(modifiers) {
                                            var orderedModifiers =
                                                order(modifiers);
                                            return enums.xs.reduce(function (
                                                acc,
                                                phase
                                            ) {
                                                return acc.concat(
                    ...
                    var mainClippingParents =
                            "clippingParents" === boundary
                                ? (function getClippingParents(element) {
                                      ...
                                      return isElement(clipperElement)
                                          ? clippingParents.filter(function (
                                                clippingParent
                                            ) {
                                                return (
                                                    isElement(clippingParent) &&
                                ...
                                : [].concat(boundary),
                        clippingParents = [].concat(mainClippingParents, [
                            rootBoundary,
                        ]),
                        ...
                        clippingRect = clippingParents.reduce(function (
                            ...
                            return (
                                ...
                                (accRect.right = math_min(
                                    rect.right,
                                    accRect.right
                                )),
                                (accRect.bottom = math_min(
                                    rect.bottom,
                                    accRect.bottom
                                )),
                                (accRect.left = math_max(
                                    rect.left,
                                    accRect.left
                                )),
                                accRect
                ...
                function detectOverflow(state, options) {
                    ...
                    var _options = options,
                        ...
                        altBoundary =
                            void 0 !== _options$altBoundary &&
                            _options$altBoundary,
                        _options$padding = _options.padding,
                        padding =
                            void 0 === _options$padding ? 0 : _options$padding,
                        ...
                        altContext =
                            elementContext === enums.k5 ? enums.YP : enums.k5,
                    ...
                    if (elementContext === enums.k5 && offsetData) {
                        ...
                        Object.keys(overflowOffsets).forEach(function (key) {
                            var multiply =
                                    [enums.F2, enums.I].indexOf(key) >= 0
                                        ? 1
                                        : -1,
                                axis =
                                    [enums.we, enums.I].indexOf(key) >= 0
                                        ? "y"
                                        : "x";
                ...
                const modifiers_preventOverflow = {
                    ...
                    fn: function preventOverflow(_ref) {
                        var state = _ref.state,
                            ...
                            tether =
                                void 0 === _options$tether || _options$tether,
                            _options$tetherOffset = options.tetherOffset,
                            tetherOffset =
                                void 0 === _options$tetherOffset
                                    ? 0
                        ...
                        if (popperOffsets) {
                            if (checkMainAxis) {
                                var _offsetModifierState$,
                                    mainSide =
                                        "y" === mainAxis ? enums.we : enums.t$,
                                    altSide =
                                        "y" === mainAxis ? enums.I : enums.F2,
                            ...
                            if (checkAltAxis) {
                                var _offsetModifierState$2,
                                    _mainSide =
                                        "x" === mainAxis ? enums.we : enums.t$,
                                    _altSide =
                                        "x" === mainAxis ? enums.I : enums.F2,
                ...
                const modifiers_arrow = {
                    ...
                    fn: function arrow(_ref) {
                        ...
                        if (arrowElement && popperOffsets) {
                            var paddingObject = (function toPaddingObject(
                                    padding,
                                    state
                                ) {
                            ...
                            state.modifiersData[name] =
                                (((_state$modifiersData$ = {})[axisProp] =
                                    offset),
                                (_state$modifiersData$.centerOffset =
                                    offset - center),
                ...
                function getSideOffsets(overflow, rect, preventedOffsets) {
                    return (
                        void 0 === preventedOffsets &&
                            (preventedOffsets = { x: 0, y: 0 }),
                        {
                            top:
                                overflow.top - rect.height - preventedOffsets.y,
                            right:
                                overflow.right -
                                rect.width +
                                preventedOffsets.x,
                            bottom:
                                ...
                                preventedOffsets.y,
                            left:
                                overflow.left - rect.width - preventedOffsets.x,
                        }
                    );
                }
                            ...
                            },
                            {
                                ...
                                fn: function computeStyles(_ref4) {
                                    var state = _ref4.state,
                                        ...
                                        gpuAcceleration =
                                            void 0 === _options$gpuAccelerat ||
                                            _options$gpuAccelerat,
                                        _options$adaptive = options.adaptive,
                                        adaptive =
                                            void 0 === _options$adaptive ||
                                            _options$adaptive,
                                        _options$roundOffsets =
                                            options.roundOffsets,
                                        roundOffsets =
                                            void 0 === _options$roundOffsets ||
                                            _options$roundOffsets,
                                        commonStyles = {
                            ...
                            modifiers_offset,
                            {
                                ...
                                fn: function flip(_ref) {
                                    ...
                                    if (!state.modifiersData[name]._skip) {
                                        ...
                                        state.placement !==
                                            firstFittingPlacement &&
                                            ((state.modifiersData[name]._skip =
                                                !0),
                                            (state.placement =
                                                firstFittingPlacement),
                                            (state.reset = !0));
                            ...
                            modifiers_arrow,
                            {
                                ...
                                fn: function hide(_ref) {
                                    var state = _ref.state,
                                        ...
                                        referenceOverflow = detectOverflow(
                                            state,
                                            { elementContext: "reference" }
                                        ),
                                        popperAltOverflow = detectOverflow(
                                            state,
                                            { altBoundary: !0 }
                                        ),
                ...
                function Popper(_ref) {
                    var _ref$placement = _ref.placement,
                        ...
                        strategy =
                            void 0 === _ref$strategy
                                ? "absolute"
                                : _ref$strategy,
                        _ref$modifiers = _ref.modifiers,
                        modifiers =
                            void 0 === _ref$modifiers
                                ? Popper_EMPTY_MODIFIERS
                                : _ref$modifiers,
                        ...
                        referenceNode = react.useContext(
                    ...
                    var options = react.useMemo(
                        ...
                        _usePopper = (function usePopper(
                            ...
                            var prevOptions = react.useRef(null),
                                ...
                                updateStateModifier = react.useMemo(
                                    function () {
                                        return {
                                            name: "updateState",
                                            enabled: !0,
                    ...
                    Tooltip = (function (_Component) {
                        function Tooltip() {
                            ...
                            return (
                                ...
                                (_this.handleOutsideRightClick = function (
                                    event
                                ) {
                                    if (
                                        _this.tooltipRef &&
                                ...
                                (_this.contextValue = {
                                    isParentNoneTriggered:
                                        "none" === _this.props.trigger,
                                    addParentOutsideClickHandler:
                                        _this.addOutsideClickHandler,
                        ...
                        return (
                            ...
                            (_proto.isTriggeredBy = function isTriggeredBy(
                                event
                            ) {
                    ...
                    function TooltipTrigger() {
                        ...
                        return (
                            ...
                            (_this.setTooltipState = function (state) {
                                var cb = function cb() {
                                    return _this.props.onVisibilityChange(
                                        state.tooltipShown
                                    );
                                };
                                _this.isControlled()
                        ...
                        (_proto.render = function render() {
                            var _this2 = this,
                                ...
                                closeOnReferenceHidden =
                                    _this$props.closeOnReferenceHidden,
                                ...
                                mutationObserverOptions =
                                    _this$props.mutationObserverOptions,
                                restProps = (0, objectWithoutPropertiesLoose.Z)(
                                    _this$props,
                                    [
                                        "children",
                                        "tooltip",
                                        ...
                                        if (
                                            ...
                                            var _this2$state = _this2.state,
                                                ...
                                                _this2$popperOffset =
                                                    _this2.popperOffset,
                                                width =
                                                    _this2$popperOffset.width,
                                                height =
                                                    _this2$popperOffset.height,
                                                x =
                                                    pageX + width >
                                                    window.pageXOffset +
                                                        document.body
                ...
                var _templateObject,
                    ...
                    match = memoizerific_default()(1e3)(function (
                        ...
                        var fallback =
                            arguments.length > 3 && void 0 !== arguments[3]
                                ? arguments[3]
                                : 0;
                        return actual.split("-")[0] === requests
                            ? value
                            : fallback;
                    }),
                    Arrow = esm.zo.div(
                    ...
                    Tooltip_Tooltip = function Tooltip(_ref5) {
                        ...
                        return react.createElement(
                            Wrapper,
                            _extends(
                                { hasChrome, placement, ref: tooltipRef },
                                props,
                                { color }
                            ),
                            hasChrome &&
                ...
                function WithTooltip_objectWithoutProperties(source, excluded) {
                    ...
                    var key,
                        i,
                        target =
                            (function WithTooltip_objectWithoutPropertiesLoose(
                                source,
                                excluded
                            ) {
                                if (null == source) return {};
                ...
                var WithTooltip_document = window_default().document,
                    TargetContainer = esm.zo.div(
                        ...
                        function (props) {
                            return "hover" === props.mode
                                ? "default"
                                : "pointer";
                        }
                    ),
                    TargetSvgContainer = esm.zo.g(
                        _templateObject2 ||
